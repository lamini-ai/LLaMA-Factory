...
from .skinny_mome import run_skinny_mome
...
def _training_function(config: Dict[str, Any]) -> None:
    ...
    elif finetuning_args.stage == "skinny_mome":
        run_skinny_mome(model_args, data_args, training_args, finetuning_args, callbacks)
    else:
